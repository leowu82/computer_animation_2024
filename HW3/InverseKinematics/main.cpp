...
// Animation Selection
const char* animations[] = {"walk_fwd_circle.amc", "walk_fwd_curve1.amc", "walk_fwd_around.amc", "walk_back_circle.amc", 
                            "walk_back_curve1.amc", "walk_fwd_straight.amc", 
                            "walk_fwd_turn1.amc",
                            "walk_side_curve1.amc",
                            "walk_side_turn1.amc"};
static char* current_animations[] = {(char*)animations[0], (char*)animations[1], (char*)animations[2],
                                     (char*)animations[3], (char*)animations[4], (char*)animations[5], 
                                     (char*)animations[6], (char*)animations[7], (char*)animations[8]};
...
int main() {
    ...
    acclaim::Motion thirdAnimation =
        acclaim::Motion(acclaim_folder / "walk_fwd_around.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
     acclaim::Motion Animation4 =
        acclaim::Motion(acclaim_folder / "walk_back_circle.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
     acclaim::Motion Animation5 =
        acclaim::Motion(acclaim_folder / "walk_back_curve1.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
     acclaim::Motion Animation6 =
        acclaim::Motion(acclaim_folder / "walk_fwd_straight.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
     acclaim::Motion Animation7 =
        acclaim::Motion(acclaim_folder / "walk_fwd_turn1.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
     acclaim::Motion Animation8 =
        acclaim::Motion(acclaim_folder / "walk_side_curve1.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
     acclaim::Motion Animation9 =
        acclaim::Motion(acclaim_folder / "walk_side_turn1.amc", std::make_unique<acclaim::Skeleton>(*fkskeleton));
    ...
    animationFrames.push_back(Animation4.getFrameNum());
    animationFrames.push_back(Animation5.getFrameNum());
    animationFrames.push_back(Animation6.getFrameNum());
    animationFrames.push_back(Animation7.getFrameNum());
    animationFrames.push_back(Animation8.getFrameNum());
